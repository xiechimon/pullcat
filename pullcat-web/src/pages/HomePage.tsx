  ...
  return (
    <>
      <div className="transition-all duration-700 ease-in-out flex flex-col items-center text-center px-4 overflow-hidden max-h-[500px] opacity-100 pt-28 md:pt-36 pb-12 mb-4">
        ...
        <p className="text-lg md:text-xl font-serif text-gray-600 dark:text-gray-400 max-w-2xl mb-8 leading-relaxed">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-full hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-emerald-600 dark:hover:text-emerald-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all shadow-sm"
        >
