    ...
    <>
      <div className="transition-all duration-700 ease-in-out flex flex-col items-center text-center px-4 overflow-hidden max-h-[500px] opacity-100 pt-28 md:pt-36 pb-12 mb-4">
        <a
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1 mb-6 text-xs font-medium text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 bg-gray-100/50 hover:bg-gray-100 dark:bg-gray-800/50 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full transition-colors"
        >
