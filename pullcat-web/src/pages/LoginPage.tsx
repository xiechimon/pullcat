      ...
      <section className="surface-card overflow-hidden">
        <div className="grid gap-0 md:grid-cols-[minmax(0,1.08fr)_16rem]">
          ...
          <div className="border-t border-slate-200 bg-slate-50/70 px-5 py-8 dark:border-slate-800 dark:bg-slate-900/50 md:border-l md:border-t-0 md:px-6">
            <div className="text-xs font-semibold uppercase tracking-[0.14em] text-slate-400 dark:text-slate-500">登录后</div>
            <div className="mt-4 space-y-3">
              ...
              <div className="rounded-xl bg-white px-4 py-4 text-sm text-slate-950 dark:bg-slate-950/70 dark:text-white">配置自动发布</div>
            </div>
          </div>
        </div>
      </section>
