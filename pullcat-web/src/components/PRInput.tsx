...
export function PRInput({ onSubmit, loading, compact = false }: PRInputProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className={`home-review-form ${compact ? 'home-review-form--compact' : ''}`}>
      {!compact && (
