...
import com.pullcat.service.llm.ConsistencyAnalysisService;
import org.springframework.ai.chat.client.ChatClient;

/**
 * 代码一致性分析服务，检查 PR 变更与现有代码库风格是否一致
 */
public class ConsistencyAnalysisServiceImpl extends AnalysisTask implements ConsistencyAnalysisService {
