...
import com.pullcat.service.llm.TestingGapAnalysisService;
import org.springframework.ai.chat.client.ChatClient;

/**
 * 测试覆盖分析服务，检查 PR 变更中的测试覆盖缺口
 */
public class TestingGapAnalysisServiceImpl extends AnalysisTask implements TestingGapAnalysisService {
